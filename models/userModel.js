...
const userSchema = new mongoose.Schema({
  ...
  passwordConfirm: {
    ...
    validate: {
      //this would only work on create and save
...
userSchema.pre('save', async function (next) {
  //only runs if password wass modified
...
userSchema.methods.createPasswordResetToken = function () {
  ...
  this.passwordResetsToken = crypto
    .createHash('sha256')
    .update(resetToken)
    .digest('hex');

  console.log({ resetToken }, this.passwordResetsToken);
